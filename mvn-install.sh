...
mvn install:install-file -Dfile=./target/helio-framework-0.2.3.jar -DgroupId=oeg.helio.framework -DartifactId=helio-framework -Dversion=0.2.3 -Dpackaging=jar
